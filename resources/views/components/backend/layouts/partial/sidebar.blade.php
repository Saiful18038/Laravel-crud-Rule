            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        ...
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/layout_2/LTR/default/full/index.html"
                                class="nav-link">Layout 2</a></li>
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/layout_3/LTR/default/full/index.html"
                                class="nav-link">Layout 3</a></li>
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/layout_4/LTR/default/full/index.html"
                                class="nav-link">Layout 4</a></li>
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/layout_5/LTR/default/full/index.html"
                                class="nav-link">Layout 5</a></li>
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/layout_6/LTR/default/full/index.html"
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Themes">
                        ...
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/LTR/material/full/index.html"
                                class="nav-link">Material</a></li>
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/LTR/dark/full/index.html"
                                class="nav-link">Dark</a></li>
                        <li class="nav-item"><a href="{{ asset('ui/backend') }}/LTR/clean/full/index.html"
                ...
                <li class="nav-item"><a href="{{ asset('ui/backend') }}/RTL/default/full/index.html"
                        class="nav-link"><i class="icon-width"></i> <span>RTL version</span></a></li>
                <!-- /main -->
